      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-l">
                {messages["roles_description"] || "Find all of your company's administrator accounts and their associate roles."}
            </p>
      </div>
      </div>
              ...
              <Table>
                ...
                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                  <TableRow>
                    ...
                    >
                      {messages["table_user"] || "User"}
                    </TableCell>
                    <TableCell
                      isHeader
                      className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"
                    >
                     {messages["table_project"] || "Project Name"}
                    </TableCell>
                    <TableCell
                      isHeader
                      className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"
                    >
                      {messages["table_team"] || "Team"}
                    </TableCell>
                    <TableCell
                      isHeader
                      className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"
                  ...
                  {tableData.map((order) => (
                    <TableRow key={order.id}>
                      ...
                      <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                        ...
                        >
                            {messages[`status_${order.status.toLowerCase()}`] || order.status}
                        </Badge>
                      </TableCell>
